                        ...
                        <form action="{{ route('examen.update') }}" method="POST" id='formularioupd'>
                            ...
                            <div class="form-group">
                                <div class="row ">
                                    <div class="col-md col-sm col-xs">
                                        <label for="">Nombre</label>
                                        <input type="text" required class="form-control" id="nombreupd"
                                ...
                                <div class="row ">
                                    <div class="col-md col-sm col-xs">
                                        <label for="peso">Peso (%)</label>
                                        <input type="number" required class="form-control" id="pesoupd"
                                            min="1" max="100" name="peso"
        ...
        <!- /////////////////////////////BODY////////////////////////////->
            <div class="card">
                <div class="card-header">
                    <div class='col'>
                        <button data-toggle="modal" data-target="#modaladd" class='btn btn-success'><i
