    ...
    <form action="{{ route('examen') }}" method="get">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="row">
                        @include('layouts.filter.index', ['filtro' => 'nombreexamen'])
                        @include('layouts.filter.index', ['filtro' => 'caracelim', 'tipo' => 1])
                        ...
                        <div class="form-group">
                            ...
                            <div class="row ">
                                <div class="col-md col-sm col-xs">
                                    ...
                                    <input type="number" required class="form-control" id="peso" min="1"
                                        max="100" name="peso" placeholder="Ingrese porcentaje" />
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row ">
                                <div class="col-md col-sm col-xs">
                                    ...
                                    <input type="number" required id="nota_apro" min="1" name="nota_apro"
                                        class="form-control" placeholder="Ingrese Nota" />
                                </div>
                                <div class="col-md col-sm col-xs">
                                    <label for="">Nota Maxima</label>
                                    <input type="number" required id="nota_maxi" min="1" name="nota_maxi"
                                        class="form-control" placeholder="Ingrese Nota" />
                                </div>
                            </div>
                            <br>
                    ...
                    <form action="{{ route('examen.update') }}" method="POST" id='formularioupd'>
                        ...
                        <div class="form-group">
                            <div class="row ">
                                <div class="col-md col-sm col-xs">
                                    <label for="">Nombre</label>
                                    <input type="text" required class="form-control" id="nombreupd" name="nombre"
                                        placeholder="Ingrese Nombre" />
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row ">
                                <div class="col-md col-sm col-xs">
                                    <label for="enlace">Enlace</label>
                                    <input type="text" class="form-control" id="enlaceupd" name="enlace"
                                        placeholder="Ingrese Enlace" />
                                </div>
                            </div>
                            <br>
                            <div class="row ">
                                <div class="col-md col-sm col-xs">
                                    <label for="peso">Peso (%)</label>
                                    <input type="number" required class="form-control" id="pesoupd" min="1"
                                        max="100" name="peso" placeholder="Ingrese porcentaje" />
                                </div>
                            </div>
                            <br>
                            ...
                            <div class="row ">
                                <div class="col-md col-sm col-xs">
                                    <label for="">Nota de Aprobación</label>
                                    <input type="number" required id="nota_aproupd" min="1" name="nota_apro"
                                        class="form-control" placeholder="Ingrese Nota" />
                                </div>
                                <div class="col-md col-sm col-xs">
                                    <label for="">Nota Maxima</label>
                                    <input type="number" required id="nota_maxiupd" min="1" name="nota_maxi"
                                        class="form-control" placeholder="Ingrese Nota" />
                                </div>
                            </div>
                            <br>
                ...
                <tbody>
                    @foreach ($examenes as $k => $exa)
                        <tr>
                            ...
                            <td>{{ $exa->peso }}</td>
                            <td
                                style="color:@if ($exa->cara_elim == 'S') green  @elseif ($exa->cara_elim == 'N')  red @endif">
                                @if ($exa->cara_elim == 'S')
                                    Si
                                @elseif ($exa->cara_elim == 'N')
                                    No
                                @endif
                            </td>
                            <td
                                style="color:@if ($exa->flag_jura == 'S') green  @elseif ($exa->flag_jura == 'N')  red @endif">
                                @if ($exa->flag_jura == 'S')
                                    Si
                                @elseif ($exa->flag_jura == 'N')
                                    No
                                @endif
                            </td>
                            @if (!getSeccion())
                            ...
                            <td>
                                ...
                                @if ($exa->flag_jura == 'S')
                                    <button class='btn btn-success fa fa-plus-circle'
                                        onclick="Cargar({{ $exa->id_examen }})"></button>
                                @endif
                                <button class='btn btn-danger fa fa-trash'
                                    onclick="eliminarexamen({{ $exa->id_examen }})"></button>
                            </td>
                        </tr>
                    @endforeach
                </tbody>
...
@section('js')
    <script>
        function editarexamen(id_examen, id_examen_admision, nombre, descripcion, id_seccion, nota_apro, nota_maxi,
            cara_elim, flag_jura, enlace, peso) {
        ...
        function editar(id, idsec) {
            ...
            input2 = "<input required type='number' min=1 max=100 name='porcentaje' class='form-control' value='" + valor2 +
                "'>";
            chec = "<a href='#' onclick='formulario(" + '"' + idsec + '"' +
                ")' class='save'><i class='fa fa-check'></i></a>";
            del = "<a href='#' onclick='Cancelar(" + '"' + id + '"' + "," + '"' + valor1 + '"' + "," + '"' + valor2 + '"' +
                ")' class='delete'><i class='fa fa-undo'></i></a>";
