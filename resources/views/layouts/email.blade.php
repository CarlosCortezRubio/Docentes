            ...
            <tr>
                <td width="80%" cellpadding="0" cellspacing="0"
                    ...
                    <table class="inner-body" align="center" width="80%" cellpadding="0" cellspacing="0"
                        role="presentation"
                        style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; background-color: #ffffff; margin: 0 auto; padding: 0; width: 80%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 80%;">
                        <!-- Body content -->
                        <tbody>
                            <tr>
                                <td
                                    style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; color: #3d4852; line-height: 1.5em; margin-top: 0; margin-bottom: 35px; text-align: left; font-size: 12px;">
                                                        Este mensaje se encuentra dirigido exclusivamente para uso del
                                                        destinatario previsto y contiene información confidencial y/o
                                                        privilegiada. Si usted no es el destinatario al que se dirigió
                                                        el mensaje, se le notifica por este medio que la divulgación,
                                                        copia, distribución o cualquier actividad tomada a partir del
                                                        contenido de este mensaje se encuentra terminantemente prohibida
                                                        y es sancionada por la ley. Si usted ha recibido este mensaje
                                                        por error por favor proceda a eliminarlo y notificar
                                                        inmediatamente al remitente.</p>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
            ...
            <tr style="background-color:#F7F7F7;">
                <td
                    ...
                    <table class="footer" align="center" width="80%" cellpadding="0" cellspacing="0"
                        role="presentation"
                        style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; box-sizing: border-box; margin: 0 auto; padding: 0; text-align: center; width: 80%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 80%;">
                        <tbody>
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p
                                        ...
                                        &copy; 2019 Conservatorio Nacional de Música. Todos los derechos reservados.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
